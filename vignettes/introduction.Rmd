...
At level 3, pixels are assigned to a static location on the earth surface ("bin"). Bins are approximately equal area and are based on a sinusoidal projection. More info [here](https://oceancolor.gsfc.nasa.gov/docs/format/l3bins/).  
