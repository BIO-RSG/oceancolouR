...
#' Calculate Nechad SPM
#'
#' Given a sensor name, calculate SPM using Nechad's model. Note that the input to this function is Rrs, which is converted to rho within the function by multiplying by pi.
#'
